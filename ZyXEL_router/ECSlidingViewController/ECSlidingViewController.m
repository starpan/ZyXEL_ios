...
- (void)updateUnderLeftLayout  //Design Leftlayout
{
  if (self.underLeftWidthLayout == ECFullWidth) {
    [self.underLeftView setAutoresizingMask:self.autoResizeToFillScreen];
//***************************************************Design Leftlayout**************************************
//    CGRect testframe = CGRectMake(30.0f, 100.0f, self.view.bounds.size.width,self.view.bounds.size.height);
//    [self.underLeftView setFrame:testframe];
//***************************************************Leftlayout End*****************************************
